          ...
          {dataHash ? (
            <div>
              {!hasImageExtension(dataFileName) && (
                <a
                  src={`http://afedcb263daee11e9a62c0e21c210ae1-1865340558.us-east-1.elb.amazonaws.com:5001/api/v0/cat?arg=${dataHash}/${dataFileName}`}
                  className={`${styles.submissionMediaItem}`}
                >
                  <FontAwesomeIcon
                    icon={faFileArchive}
              ...
              {hasImageExtension(dataFileName) && (
                <a
                  className={`${styles.submissionMediaItem}`}
                  href={`http://afedcb263daee11e9a62c0e21c210ae1-1865340558.us-east-1.elb.amazonaws.com:5001/api/v0/cat?arg=${dataHash}/${dataFileName}`}
                  target="_blank"
                >
                  <img
                    src={`http://afedcb263daee11e9a62c0e21c210ae1-1865340558.us-east-1.elb.amazonaws.com:5001/api/v0/cat?arg=${dataHash}/${dataFileName}`}

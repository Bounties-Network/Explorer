  ...
  render() {
    ...
    return (
      <div className={`${styles.createNewBounty}`}>
        <div
          className={`${styles.createNewBountyHeader} row center-xs middle-xs`}
        >
        ...
        <div className={`${styles.createNewBountySpace}`}>
          <div className="row">
                ...
                <div className={`${styles.formSection} row`}>
                  ...
                  <div className={`col-lg-8 ${styles.detailBody}`}>
                    <div className={`${styles.subsectionHeader}`}>
                      <Text
                        className={`${styles.subsectionHeaderText}`}
                        style="H4"
                      >
                ...
                <div className={`${styles.formSection} row`}>
                  ...
                  <div className={`col-lg-8 ${styles.detailBody}`}>
                    <div className={`${styles.subsectionHeader}`}>
                      ...
                      <Text style="BodySmall" color="grey">
                        Enter the categories and difficulty level for the
                        bounty. Since difficulty can be fairly subjective, it is
                        helpful to provide more details around required
                        experience within your bounty description.
                      </Text>
                    </div>
                    <div className={`${styles.contactArea}`}>
                      <div className={`${styles.contactInputArea}`}>
                ...
                <div className={`${styles.formSection} row`}>
                  ...
                  <div className={`col-lg-8 ${styles.detailBody}`}>
                    <div className={`${styles.subsectionHeader}`}>
                      ...
                      <Text style="BodySmall" color="grey">
                        Enter the maximum number of revisions you may require
                        for this task, in order to help set expectations for the
                        contributors.
                      </Text>
                    </div>
                    <div className={`${styles.contactArea}`}>
                  ...
                  <div className={`col-lg-8 ${styles.detailBody}`}>
                    <div className={`${styles.subsectionHeader}`}>
                      <Text
                        ...
                        style="H4"
                      >
                        Does the bounty require any external assets for
                        completion?
                      </Text>
                      <Text style="BodySmall" color="grey">
                        Attach any files or links that may be helpful as
                        references or necessary for a contributor to complete
                        the bounty.
                      </Text>
                    </div>
                    <div className={`${styles.contactArea}`}>
                ...
                <div className={`${styles.formSection} row`}>
                  ...
                  <div className={`col-lg-8 ${styles.detailBody}`}>
                    <div className={`${styles.subsectionHeader}`}>
                      ...
                      <Text style="BodySmall" color="grey">
                        If you wish to activate the bounty later, you can save
                        it as a draft. The requirements for a bounty can only be
                        edited while it is in the draft stage.
                      </Text>
                    </div>
                    <div className={`${styles.contactArea}`}>
                      <div className={`${styles.contactInputArea}`}>

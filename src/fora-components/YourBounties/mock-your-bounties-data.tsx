...
export const mockYourBountiesDraftData = [{
...
export const mockYourBountiesActiveData = [{
  href: 'https://www.google.co.uk',
  title: '🗺 ️BOOST Bounty - Mentorship Reward 🗺️', timestamp: moment().subtract(2, 'days'), submissionsCount: 0, community: { name: 'social impact', href: 'https://www.google.co.uk' },
  status: 'active',
  ethUSDAmount: 435,
...
},
{
  ...
  {
    href: 'https://www.google.co.uk',
    title: 'Totle - Bounty @ ETHDenver 2019 (2nd Prize)', timestamp: moment().subtract(2, 'days'), submissionsCount: 0, community: { name: 'social impact', href: 'https://www.google.co.uk' },
    status: 'active',
    ethUSDAmount: 435,
    ethAmount: 0.5,
  }

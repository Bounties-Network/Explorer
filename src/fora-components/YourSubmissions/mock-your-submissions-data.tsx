...
export const mockYourSubmissionsReceivedData: ISubmissionProps[] = [
  {
    ...
    submissionsCount: 0,
    community: { name: "social impact", href: "https://www.google.co.uk" },
    status: "draft",
    ethUSDAmount: 435,
    ethAmount: 0.5,
    submission: {
...
export const mockYourSubmissionsSubmittedData = [
  {
    href: "https://www.google.co.uk",
    title:
      "[Deploy Contract] Add overlay to modal loader while deploying a new contract.",
    timestamp: moment().subtract(2, "days"),
    submissionsCount: 0,
    community: { name: "social impact", href: "https://www.google.co.uk" },
    status: "active",
  ...
  },
  {
    href: "https://www.google.co.uk",
    title:
      "🎨🔥 Faces of Ethereum Project - The Bounties Network x Pixura x #ArtProject",
    timestamp: moment().subtract(2, "days"),
    submissionsCount: 0,
    community: { name: "social impact", href: "https://www.google.co.uk" },
    status: "active",
  ...
  {
    href: "https://www.google.co.uk",
    title: "PARKOUR BOUNTY 1 — APEX SCHOOL OF MOVEMENT ✖️ BOUNT ...",
    timestamp: moment().subtract(2, "days"),
    submissionsCount: 0,
    community: { name: "social impact", href: "https://www.google.co.uk" },
    status: "active",

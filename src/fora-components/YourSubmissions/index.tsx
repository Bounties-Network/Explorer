...
const Submission: React.FC<ISubmissionProps> = props => (
  <Flex flexDirection="column">
    <Flex sx={{ pt: 3, px: 3 }} alignItems="center">
      ...
      <Flex
        alignItems="center"
        sx={{ ml: "auto", "> :not(:last-of-type)": { mr: 3 } }}
      >
...
const YourSubmissionsTab = React.forwardRef<
  any,
...
const YourSubmissions: React.FunctionComponent<YourSubmissionsProps> = props => (
  ...
  >
    <TabList>
      <YourSubmissionsTab
        label="Received"
        notificationCount={props.receivedNotificationCount}
      ></YourSubmissionsTab>
      <YourSubmissionsTab
        label="Submitted"
        notificationCount={props.submittedNotificationCount}
      ></YourSubmissionsTab>
    </TabList>

    <TabPanels>
      <TabPanel sx={{ pt: 0 }}>
        {props.received.map(Submission)}

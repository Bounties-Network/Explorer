...
function RequireLoginComponentHOC(WrappedComponent) {
  class RequireLoginComponent extends Component {
    ...
    render() {
      ...
      if (!isLoggedIn) {
        return (
          <div className={`${styles.notLoggedIn} row middle-xs center-xs`}>
                  ...
                  <div className="row center-xs">
                    <div className="col-xs-7">
                      ...
                      >
                        <div>
                          <ZeroState.BodyText>
                            In order for you to use certain features of the
                            network like creating and fulfilling bounties,
                            commenting, and viewing your network stats, please
                            sign in using your secure wallet.
                          </ZeroState.BodyText>
                        </div>
                        <div className={styles.subText}>
                          <ZeroState.BodyText>
                            If you don&#39;t wish to sign in but want to
                            explore, feel free to check out some bounties using
                            the{' '}
                          </ZeroState.BodyText>
                          <ZeroState.BodyText>
